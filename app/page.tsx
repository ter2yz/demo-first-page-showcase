...
import { ContactFormModeProvider } from "@/components/ContactForm";
            ...
            <figure className="w-full flex-auto pt-4">
              <blockquote className="text-[1.625rem] xl:text-3xl">
                <p className="mb-5 leading-10 font-semibold text-white italic">
                  <span className="text-[2.875rem]">&#34;</span>First Page
                  nailed our brief and executed a strategy that was aligned with
                  our goals.&#34;
                </p>
